...
<div class="right">
	...
	<tr>
		...
		<td><input type="text" name="title" value="<?php echo $data['title'];?>" class="inputall" /></td>
	</tr>
	<tr>
		<td class="bg_f8" align="right">规格：</td>
		<td><input id='s1' type="radio" name="attr_type" value="0"     <?php if($data['attr_type']==0){ ?>checked<?php } ?> />&nbsp;属性&nbsp;&nbsp;<input id='s2' type="radio" name="attr_type" value="1"     <?php if($data['attr_type']==1){ ?>checked<?php } ?> />&nbsp;规格</td>
	</tr>
	...
	<tr>
		...
		<input type="hidden" value='<?php echo $data['show_type'];?>' name='show_type' />
