...
<div class="right">
	<div class="now">
		<div class="now_l"></div>
		<div class="now_m">
			<span class="fl">属性列表</span>
			<span class="fr fabu"><a href="<?php echo U('TypeAttr/add', array('tid' =>$_GET['tid']));?>">增加属性</a></span>
		</div>
		<div class="now_r"></div>
		<div class="clear"></div>
	</div>
	...
	<tr>
		<td class="bgtt" width="50">属性ID</td>
		<td class="bgtt" width="150">属性名称</td>
		<td class="bgtt">规格</td>
		<td class="bgtt" width="100">属性类型</td>
	...
	<?php foreach ($data as $k=>$v){?>
		...
		<td>
			<a href="<?php echo U('TypeAttr/edit', array('tid'=>$v['type_id'], 'taid'=>$v['taid']));?>" class="admin_edit mar3">修改</a>
			<a href="javascript:;" class="admin_del" onclick="if(confirm('确定删除吗？')) location.href='<?php echo U('TypeAttr/del',array('tid'=>$v['type_id'], 'taid'=>$v['taid']));?>'">删除</a>
		</td>
	</tr>
	<?php }?>
	<!-- 循环结束 -->
