...
<div class="right">
	...
	<tr>
		<td class="bg_f8" align="right">banner地址：</td>
		<td><input type="text" name="url" value="<?php echo $data['url'];?>" class="inputall" /></td>
	</tr>
	<tr>
		<td class="bg_f8" align="right">banner图片：</td>
		<td>
			...
			<?php }else{ ?>
				<p><img src="http://localhost/yoho/<?php echo $data['pic'];?>" style="border:1px solid #ddd" width="200" /></p>
			<?php } ?>
			<input type="hidden" name="pich" value="<?php echo $data['pic'];?>" />
			<p><input type="file" name="pic" /></p>
		</td>
	</tr>
	<tr>
		<td class="bg_f8" align="right">是否显示：</td>
		<td><input type="radio" name="is_show" value="0"     <?php if($data['is_show']==0){ ?>checked="checked"<?php } ?> />&nbsp;否&nbsp;&nbsp;<input type="radio" name="is_show" value="1"     <?php if($data['is_show']==1){ ?>checked="checked"<?php } ?> />&nbsp;是</td>
	</tr>
	<tr>
		<td class="bg_f8">&nbsp;</td>
		<input type="hidden" name="banner_id" value="<?php echo $hd['get']['bid'];?>" />
