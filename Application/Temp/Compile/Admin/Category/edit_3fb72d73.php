...
<div class="right">
	...
	<tr>
		...
		<td><input type="text" name="name" value="<?php echo $oldData['name'];?>" class="inputall input200" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="radio" name="is_show" value="0"     <?php if($oldData['is_show']==0){ ?>checked<?php } ?> />&nbsp;否&nbsp;&nbsp;<input type="radio" name="is_show" value="1"     <?php if($oldData['is_show']==1){ ?>checked<?php } ?> />&nbsp;是</td>
	</tr>
	<tr>
		<td class="bg_f8">&nbsp;</td>
		<input type="hidden" name="cid" value="<?php echo $oldData['category_id'];?>" />
