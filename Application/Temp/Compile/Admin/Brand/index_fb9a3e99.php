...
<div class="right">
	<div class="now">
		<div class="now_l"></div>
		<div class="now_m">
			<span class="fl">品牌列表</span>
			<span class="fr fabu"><a href="<?php echo U('Brand/add');?>">增加品牌</a></span>
		</div>
		<div class="now_r"></div>
		<div class="clear"></div>
	</div>
	...
	<tr>
		...
		<td class="bgtt" width="150">名称</td>
		<td class="bgtt">品牌图片</td>
		<td class="bgtt" width="50">排序</td>
		<td class="bgtt" width="100">是否热门</td>
	...
	<?php foreach ($data as $k=>$v){?>
		...
		<?php }else{ ?>
			<td><a href="" target="_blank"><img src="http://localhost/yoho/<?php echo $v['logo'];?>" height="45"  /></a></td>
		<?php } ?>
		...
		<?php } ?>
		<td>
			<a href="<?php echo U('Brand/edit', array('bid'=>$v['brand_id']));?>" class="admin_edit mar3">修改</a>
			<a href="javascript:;" class="admin_del" onclick="if(confirm('确定删除吗？')) location.href='<?php echo U('Brand/del',array('bid'=>$v['brand_id']));?>'">删除</a>
		</td>
	</tr>
	<?php }?>
	<!-- 循环结束 -->
